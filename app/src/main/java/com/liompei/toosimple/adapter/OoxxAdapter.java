 ...
 */
public class OoxxAdapter extends RecyclerView.Adapter {

    private Context context;
    private List<Map<String, String>> mapList;

    public OoxxAdapter(Context context, List<Map<String, String>> mapList) {
        ...
        public MyHolder(View itemView) {
            ...
            mLike.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    ooxxBean.setLike(String.valueOf(numLike));
                    ooxxBean.update(mapList.get(getLayoutPosition()).get("id"), new UpdateListener() {
                        @Override
            ...
            mDislike.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    OoxxBean ooxxBean = new OoxxBean();
                    ooxxBean.setDislike(String.valueOf(numDisLike));
                    ooxxBean.update(mapList.get(getLayoutPosition()).get("id"), new UpdateListener() {
                        @Override
                        public void done(BmobException e) {
                            if (e == null) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.recycler_item_ooxx, parent, false);
